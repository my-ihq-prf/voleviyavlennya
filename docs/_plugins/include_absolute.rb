...
bundle info include_absolute

bundle info include_absolute

bundle config set path _plugins/include_absolute.rb install
bundle config set path C:\Users\TNT\.bundle
docs/_plugins/include_absolute.rb

bundle install
bundle config --delete BUNDLE_SYSTEM_BINDIR
